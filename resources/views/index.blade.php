                    ...
                    <div class="flex items-centr justify-between mb-5">
                        ...
                        <div class="flex flex-col font-bold w-4/6 px-2">
                            ...
                            <select 
                                ...
                                @foreach ($codes as $code => $value)
                                    <option class="py-1" {{ session()->has('from') ? ($code == @session('from') ? 'selected' : '') : ($code == 'EUR' ? 'selected' : '') }}>
                                        {{ $code }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="flex flex-col font-bold w-4/6 px-2">
                            ...
                            <select 
                                ...
                                name="to">
                                @foreach ($codes as $code => $value)
                                    <option class="py-1" {{ session()->has('to') ? ($code == @session('to') ? 'selected' : '') : ($code == 'USD' ? 'selected' : '') }}>
                                        {{ $code }}
                                    </option>
                                @endforeach
                            </select>
